 ...
 * yellow-storefront photograph sits full-bleed on the right side.
 * The left is the manifesto: prose + the Note Pongsuang verbatim
 * pull-quote.
 *
    ...
    <section id="room" className="relative bg-vinyl text-cream py-28 lg:py-36 overflow-hidden border-t border-[var(--rule)]">
      ...
      <div className="relative mx-auto max-w-[1480px] px-6 lg:px-10 grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        <Reveal className="lg:col-span-6">
          ...
          <blockquote
            className="display-it text-cream mt-10 leading-[1.3] border-l-2 border-pop pl-6 max-w-[40ch]"
            style={{ fontSize: 'clamp(22px, 2.4vw, 30px)' }}
            lang={locale}
          >
            <span className="text-pop mr-1">&ldquo;</span>
            {r.pullQuote[locale]}
            <span className="text-pop ml-1">&rdquo;</span>
          </blockquote>
        ...
        {/* RIGHT — full-bleed yellow shopfront */}
        <Reveal delay={0.2} className="lg:col-span-6">
          <figure className="relative">
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              />
              {/* Amber + vinyl wash for cohesion with the section */}
              ...
              {/* Pop corner tag */}
              <span className="absolute top-4 left-4 bg-pop text-cream mono uppercase tracking-[0.32em] text-[10px] px-3 py-1.5">
                Plate I
              </span>
